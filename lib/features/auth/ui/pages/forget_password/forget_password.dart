...
import 'package:yadlo/features/auth/ui/pages/verify/send_code_cubit.dart';
...
class _ForgetPassword extends State<ForgetPassword> {
        ...
        if (state is SendCodeSuccess) {
          Navigator.of(context).pushReplacement(MaterialPageRoute(
              builder: (context) => AuthPage(
                    ...
                    code: '',
                    useCase: PageUseCases.ResetPassword,
                  )));
        }
                ...
                children: [
                  ...
                  Container(
                      ...
                      child: Text(
                        'Forgot Password',
                        style:
                            Styles.semiBlod(fontSize: 22, color: Colors.black),
                      )),
                  Container(
                      alignment: Alignment.center,
  ...
  void sendCodeVV(BuildContext context) {
    context.read<SendCodeCubit>().emitResetSendCodeStates(
        input: SendCodeInput(
            email: _controller.text, useCase: SendCodeTypeEnum.PASSWORD_RESET));
  }
}
